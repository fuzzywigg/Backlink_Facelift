...
describe('post144 mcp HEAVY deepen (after #144)', () => {
  ...
  it("post144: extra HMAC keys inventory digest", () => {
    const keys = ["mcp","backlink","Backlink Radio","station_select","now_playing","genre_filter","curator_prompt","openapi","schema_version","claw-mcp","fuzzywigg","iptv-org","post108","post126","VALID_GENRES","GENRE_MAP","post134","post140","post144"];
    expect(createHash('sha256').update(keys.join('|'), 'utf8').digest('hex')).toBe("64baa1f13eaa5f1ea43f6fa5152d304e5dea0311264a63feae55b74084c2449d");
    expect(keys).toHaveLength(19);
  });
