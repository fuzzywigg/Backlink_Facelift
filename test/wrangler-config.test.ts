...
describe('post144 wrangler HEAVY deepen (after #144)', () => {
  ...
  it("post144: final inventory markers", () => {
    ...
    expect((body.match(/it\("post144:/g) ?? []).length).toBeGreaterThan(100);
  });

});

describe('post144 wrangler extras HEAVY deepen (after #144 leftover slice)', () => {
  const read = (rel: string) => readFileSync(join(root, rel), 'utf8');
  const sha256 = (rel: string) => createHash('sha256').update(readFileSync(join(root, rel))).digest('hex');
  ...
  it("post144-extras: HMAC wrangler-extras wrangler.toml", () => { expect(hmacSha256('wrangler-extras', "wrangler.toml")).toBe("050097bba6d7872a6d3d437301eef241af0de2e08a7753e9ba1e372b09c70c7d"); });
  ...
  it("post144-extras: HMAC custom_domain wrangler.toml", () => { expect(hmacSha256('custom_domain', "wrangler.toml")).toBe("3ae8d9823021bfcf166b84c11cc53c3b3ab947e4e268039ce9966e0500911ea0"); });
  ...
  it("post144-extras: HMAC wrangler-extras src/types.ts", () => { expect(hmacSha256('wrangler-extras', "src/types.ts")).toBe("faa37262aa4b8b28e03e4134012028f674feea65338ecf37d4dabd12034bac76"); });
  ...
  it("post144-extras: HMAC custom_domain src/types.ts", () => { expect(hmacSha256('custom_domain', "src/types.ts")).toBe("990e5a7bdff7985dd808561c47ae1e54bc508324ee921717dfc6ab45f5960cd6"); });
  ...
  it("post144-extras: HMAC wrangler-extras src/index.ts", () => { expect(hmacSha256('wrangler-extras', "src/index.ts")).toBe("ef26306d6ac2c4dd4ddce1df7bfc627e956b82ac6e0e324371a775cd2c20139c"); });
  ...
  it("post144-extras: HMAC custom_domain src/index.ts", () => { expect(hmacSha256('custom_domain', "src/index.ts")).toBe("930eaa100009f60b0f1916d8dbab7d998f776b5097c4c3f8c7bad8210b94e992"); });
  ...
  it("post144-extras: HMAC wrangler-extras package.json", () => { expect(hmacSha256('wrangler-extras', "package.json")).toBe("dc73cd32f123b7003aaa218d1b6f3b6ae5ce3600dd86026dd64a94a3d1fd0e27"); });
  ...
  it("post144-extras: HMAC custom_domain package.json", () => { expect(hmacSha256('custom_domain', "package.json")).toBe("9cbed27a958ca95ac60ad73f62c34a6e17c867a19af822db48ddb344919f2a8c"); });
  ...
  it("post144-extras: HMAC wrangler-extras AGENTS.md", () => { expect(hmacSha256('wrangler-extras', "AGENTS.md")).toBe("29ec6f9d39aebb76587a8fcb8149a5f3f097764140620d84d553c895063691cc"); });
  ...
  it("post144-extras: HMAC custom_domain AGENTS.md", () => { expect(hmacSha256('custom_domain', "AGENTS.md")).toBe("a5c69ed257db84c8741ad93ad1941d84890b151f1d354a0c87cd8f0cbc4a7bd2"); });
  ...
  it("post144-extras: HMAC wrangler-extras DEPLOY.md", () => { expect(hmacSha256('wrangler-extras', "DEPLOY.md")).toBe("ad22a248d760e7136ba8a199003616d7529d31c822c6191425e4769d954a2a35"); });
  ...
  it("post144-extras: HMAC custom_domain DEPLOY.md", () => { expect(hmacSha256('custom_domain', "DEPLOY.md")).toBe("dac5043243672ded868692a7711b57f9638c178723779f405acc94ccba77eb18"); });
  ...
  it("post144-extras: HMAC wrangler-extras .github/workflows/ci.yml", () => { expect(hmacSha256('wrangler-extras', ".github/workflows/ci.yml")).toBe("63ac364ccda38e5fae9b325185dd4851a15a8f652c82f5dd2adee80d357764e7"); });
  ...
  it("post144-extras: HMAC custom_domain .github/workflows/ci.yml", () => { expect(hmacSha256('custom_domain', ".github/workflows/ci.yml")).toBe("9542031dda28d2570ba54ca2f5409ff2bd03fe4159ac488781ca716629e17aa5"); });
  ...
  it("post144-extras: HMAC wrangler-extras .github/workflows/deploy.yml", () => { expect(hmacSha256('wrangler-extras', ".github/workflows/deploy.yml")).toBe("274897801e10e9d758e4ac95d1d4e2c966c951e38b44a4a07661e2aed9d2c21c"); });
  ...
  it("post144-extras: HMAC custom_domain .github/workflows/deploy.yml", () => { expect(hmacSha256('custom_domain', ".github/workflows/deploy.yml")).toBe("67edf72c4858fb2cf84cc12a5f63293c9afb6f46a356e5eb2b41c431a322d5f8"); });
  ...
  it("post144-extras: HMAC wrangler-extras .cursor/environment.json", () => { expect(hmacSha256('wrangler-extras', ".cursor/environment.json")).toBe("81304c086c37e05b54e835c7ddf5d76f3402a8377de7920f2592645c5a2fcf55"); });
  ...
  it("post144-extras: HMAC custom_domain .cursor/environment.json", () => { expect(hmacSha256('custom_domain', ".cursor/environment.json")).toBe("fbbf45821dc3091adeabe072c8471c77239452821a264c14418fc0c5a95001ce"); });
  ...
  it("post144-extras: HMAC wrangler-extras vitest.config.ts", () => { expect(hmacSha256('wrangler-extras', "vitest.config.ts")).toBe("e5ba34b69de6ffca7fe17f3af3411d62ccd571b2f59d7efedb16e87071c8705d"); });
  ...
  it("post144-extras: HMAC custom_domain vitest.config.ts", () => { expect(hmacSha256('custom_domain', "vitest.config.ts")).toBe("e0a64b3a0a66f014b61437ed7d96fa773e56391feae9ffd1fef3319abe5bdc8e"); });
  ...
  it("post144-extras: toml line 0 exact", () => {
    expect(read('wrangler.toml').split('\n')[0]).toBe("name = \"backlink\"");
  });
  it("post144-extras: toml line 1 exact", () => {
    expect(read('wrangler.toml').split('\n')[1]).toBe("main = \"src/index.ts\"");
  });
  it("post144-extras: toml line 2 exact", () => {
    expect(read('wrangler.toml').split('\n')[2]).toBe("compatibility_date = \"2025-01-01\"");
  });
  it("post144-extras: toml line 4 exact", () => {
    expect(read('wrangler.toml').split('\n')[4]).toBe("[[kv_namespaces]]");
  });
  it("post144-extras: toml line 5 exact", () => {
    expect(read('wrangler.toml').split('\n')[5]).toBe("binding = \"CATALOG_CACHE\"");
  });
  it("post144-extras: toml line 6 exact", () => {
    expect(read('wrangler.toml').split('\n')[6]).toBe("id = \"edb6ca4df12f4f45b40508b3dda3c432\"");
  });
  it("post144-extras: toml line 8 exact", () => {
    expect(read('wrangler.toml').split('\n')[8]).toBe("[[routes]]");
  });
  it("post144-extras: toml line 9 exact", () => {
    expect(read('wrangler.toml').split('\n')[9]).toBe("pattern = \"backlink.fuzzywigg.com\"");
  });
  it("post144-extras: toml line 10 exact", () => {
    expect(read('wrangler.toml').split('\n')[10]).toBe("custom_domain = true");
  });
  it("post144-extras: toml line 12 exact", () => {
    expect(read('wrangler.toml').split('\n')[12]).toBe("[vars]");
  });
  it("post144-extras: toml line 13 exact", () => {
    expect(read('wrangler.toml').split('\n')[13]).toBe("VERSION = \"0.1.0\"");
  });
  it("post144-extras: toml line 15 exact", () => {
    expect(read('wrangler.toml').split('\n')[15]).toBe("# Secrets (set via CLI, never commit):");
  });
  it("post144-extras: toml line 16 exact", () => {
    expect(read('wrangler.toml').split('\n')[16]).toBe("# wrangler secret put GEMINI_API_KEY");
  });
  it("post144-extras: toml line count 18", () => { expect(read('wrangler.toml').split('\n')).toHaveLength(18); });
  it("post144-extras: toml size 330", () => { expect(statSync(join(root,'wrangler.toml')).size).toBe(330); });
  it("post144-extras: toml forbids durable_objects", () => {
    expect(read('wrangler.toml').toLowerCase()).not.toContain("durable_objects");
  });
  it("post144-extras: toml forbids workers_dev", () => {
    expect(read('wrangler.toml').toLowerCase()).not.toContain("workers_dev");
  });
  it("post144-extras: toml forbids [ai]", () => {
    expect(read('wrangler.toml').toLowerCase()).not.toContain("[ai]");
  });
  it("post144-extras: toml forbids [[r2", () => {
    expect(read('wrangler.toml').toLowerCase()).not.toContain("[[r2");
  });
  it("post144-extras: toml forbids [[d1", () => {
    expect(read('wrangler.toml').toLowerCase()).not.toContain("[[d1");
  });
  it("post144-extras: toml forbids ANTHROPIC", () => {
    expect(read('wrangler.toml').toLowerCase()).not.toContain("anthropic");
  });
  it("post144-extras: toml forbids OPENAI_API_KEY", () => {
    expect(read('wrangler.toml').toLowerCase()).not.toContain("openai_api_key");
  });
  it("post144-extras: toml forbids vectorize", () => {
    expect(read('wrangler.toml').toLowerCase()).not.toContain("vectorize");
  });
  it("post144-extras: toml forbids hyperdrive", () => {
    expect(read('wrangler.toml').toLowerCase()).not.toContain("hyperdrive");
  });
  it("post144-extras: domain pin only existing", () => {
    expect(read('wrangler.toml')).toMatch(/pattern\s*=\s*"backlink\.fuzzywigg\.com"/);
    expect(read('wrangler.toml')).toMatch(/custom_domain\s*=\s*true/);
  });
  it("post144-extras: secret via CLI comment only", () => {
    expect(read('wrangler.toml')).toMatch(/wrangler secret put GEMINI_API_KEY/);
    expect(read('wrangler.toml')).not.toMatch(/GEMINI_API_KEY\s*=/);
  });
  it("post144-extras: envjson lock no invent", () => {
    const env = JSON.parse(read('.cursor/environment.json')) as { name: string; install: string };
    expect(env.name).toBe('Backlink_Facelift');
    expect(env.install).toBe('npm ci');
  });
  it("post144-extras: mega purity 40x toml", () => {
    const expected = "95b11779a88f0544f3561eea67994a0b0b874d7b8776579189fa7142fa0473f8";
    for (let i = 0; i < 40; i++) expect(sha256('wrangler.toml')).toBe(expected);
  });
  it("post144-extras: inventory digest", () => {
    const keys = ["post144","leftover","TOKENMAXX","HEAVY","after-#144","no-product-invent","wrangler-extras","slice-diff","custom_domain","HITL","CATALOG_CACHE","edb6ca4df12f4f45b40508b3dda3c432","2025-01-01","post140","post144","extras"];
    expect(createHash('sha256').update(keys.join('|'), 'utf8').digest('hex')).toBe("dbd76feaa1d042d6b7271be312648694b7d7739e294761b148240bcb09e4d031");
    expect(keys).toHaveLength(16);
  });
  it("post144-extras: final markers", () => {
    const body = read('test/wrangler-config.test.ts');
    expect(body).toContain("describe('post144 wrangler HEAVY deepen (after #144)'");
    expect(body).toContain("describe('post144 wrangler extras HEAVY deepen (after #144 leftover slice)'");
    expect((body.match(/it\("post144-extras:/g) ?? []).length).toBeGreaterThan(50);
  });
});
