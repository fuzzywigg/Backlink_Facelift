...
describe('post144 source-contracts extras HEAVY deepen (after #144 leftover slice)', () => {
  const read = (rel: string) => readFileSync(join(root, rel), 'utf8');
  const sha256 = (rel: string) => createHash('sha256').update(readFileSync(join(root, rel))).digest('hex');
  ...
  it("post144-extras: HMAC source-extras src/index.ts", () => { expect(hmacSha256('source-extras', "src/index.ts")).toBe("36f33d876b992999a8ea668b1b2f6bc6e7444f16b9c678bf05f567bcbd0ae2d8"); });
  ...
  it("post144-extras: HMAC Env-align src/index.ts", () => { expect(hmacSha256('Env-align', "src/index.ts")).toBe("582cc5cf017fc576dc867b7e41adcc77c370b73a49654cb4cc8c5df3b24a307d"); });
  ...
  it("post144-extras: HMAC source-extras src/genres.ts", () => { expect(hmacSha256('source-extras', "src/genres.ts")).toBe("3f50e0d201d9681dcb4a8f92386502f75b06a4803ce0927ea2a75664649fe77d"); });
  ...
  it("post144-extras: HMAC Env-align src/genres.ts", () => { expect(hmacSha256('Env-align', "src/genres.ts")).toBe("a56a4d93cb198887b03cee1faad8cbe2cd5abc08cf746b2624a6b739bb05f2ce"); });
  ...
  it("post144-extras: HMAC source-extras src/mcp.ts", () => { expect(hmacSha256('source-extras', "src/mcp.ts")).toBe("20e7bc5912444516f0c4c051061aa441cadf1e9b65cc834f8148aaf19ecff96f"); });
  ...
  it("post144-extras: HMAC Env-align src/mcp.ts", () => { expect(hmacSha256('Env-align', "src/mcp.ts")).toBe("b676ecab5d94bd09e56e9ff29fa6be0ca195e58649d7a0fc2e18e0e62e4354be"); });
  ...
  it("post144-extras: HMAC source-extras src/parser.ts", () => { expect(hmacSha256('source-extras', "src/parser.ts")).toBe("9fbe3fec9c1fc9ed1b419810cb55939e5157cbeb40c6c2ab45215817801a314b"); });
  ...
  it("post144-extras: HMAC Env-align src/parser.ts", () => { expect(hmacSha256('Env-align', "src/parser.ts")).toBe("3ab9441581277dc874976928e5a2eca269ca80358cef69d53f96b45c40601ca5"); });
  ...
  it("post144-extras: HMAC source-extras src/types.ts", () => { expect(hmacSha256('source-extras', "src/types.ts")).toBe("7f648c90ac4444836249b760954a7320587b1b52de357c1b33eada1e0427dc70"); });
  ...
  it("post144-extras: HMAC Env-align src/types.ts", () => { expect(hmacSha256('Env-align', "src/types.ts")).toBe("5f3b3c5084e03b3e7c04409ebd2636ca0ab9e56141a9dacd501c63c48ae336d1"); });
  ...
  it("post144-extras: HMAC source-extras wrangler.toml", () => { expect(hmacSha256('source-extras', "wrangler.toml")).toBe("097c1c6b77d05d66d898be0187151670719aba1451c7d50253f13c38ee80fd33"); });
  ...
  it("post144-extras: HMAC Env-align wrangler.toml", () => { expect(hmacSha256('Env-align', "wrangler.toml")).toBe("c4692259051ad0b6999437782f39a254be8846b9457e4a378e2290f4541c7614"); });
  ...
  it("post144-extras: HMAC source-extras package.json", () => { expect(hmacSha256('source-extras', "package.json")).toBe("09358acf991e972efcaeb3fad262c48678ca5e97285bfe20dd9f5a660c8e512f"); });
  ...
  it("post144-extras: HMAC Env-align package.json", () => { expect(hmacSha256('Env-align', "package.json")).toBe("7acf591beb9b55a97d29243922643dd9c1760c405dedde277e781806057c2d66"); });
  ...
  it("post144-extras: HMAC source-extras AGENTS.md", () => { expect(hmacSha256('source-extras', "AGENTS.md")).toBe("bc8597bb6b747c51eecfae64e25e9120943cd7b6a33a6b45f549d601ad86b4bc"); });
  ...
  it("post144-extras: HMAC Env-align AGENTS.md", () => { expect(hmacSha256('Env-align', "AGENTS.md")).toBe("664262670430ea72f5c5981a72f460520ea27598d39d684aceb658977c83822c"); });
  ...
  it("post144-extras: HMAC source-extras DEPLOY.md", () => { expect(hmacSha256('source-extras', "DEPLOY.md")).toBe("618eb0ab5eb621e15dcca8ca8a3f7bc2dcbfacfeb3564dc6c67547c44c0aacd9"); });
  ...
  it("post144-extras: HMAC Env-align DEPLOY.md", () => { expect(hmacSha256('Env-align', "DEPLOY.md")).toBe("8f735dcabb0f4686b276ecf5b7e18e265432c5b211ade931f90969182de055d9"); });
  ...
  it("post144-extras: HMAC source-extras docs/mcp-spec.md", () => { expect(hmacSha256('source-extras', "docs/mcp-spec.md")).toBe("b6772f51738a0fb4795b4efc665dcb5b787b8ce2a9cfcd451adf19cf9075cacc"); });
  ...
  it("post144-extras: HMAC Env-align docs/mcp-spec.md", () => { expect(hmacSha256('Env-align', "docs/mcp-spec.md")).toBe("45af57580f3d9d228070cbb3cae40043eb672ffe42633d69db0c8880b692fa56"); });
  ...
  it("post144-extras: HMAC source-extras .github/workflows/ci.yml", () => { expect(hmacSha256('source-extras', ".github/workflows/ci.yml")).toBe("da68ea42e5b20cc34d6d1896c0db8fbc326664099fe4f2f290ce06963929d96b"); });
  ...
  it("post144-extras: HMAC Env-align .github/workflows/ci.yml", () => { expect(hmacSha256('Env-align', ".github/workflows/ci.yml")).toBe("7484b3c5b637c52e86640344ff41c259f1bb69d9a2db0ef1d10a4c37410a62f6"); });
  ...
  it("post144-extras: HMAC source-extras vitest.config.ts", () => { expect(hmacSha256('source-extras', "vitest.config.ts")).toBe("d508daad96df622147652ca85ee23fc2790a5545f85aff78fdaefa22db03aa71"); });
  ...
  it("post144-extras: HMAC Env-align vitest.config.ts", () => { expect(hmacSha256('Env-align', "vitest.config.ts")).toBe("5d7d43527f18974f86505573c2fa30b8933a386fc728b5b7d4023ddcac8a7a2e"); });
  ...
  it("post144-extras: resolveGenre(\"jazz\") → jazz", () => {
    expect(resolveGenre("jazz")).toBe("jazz");
  });
  it("post144-extras: resolveGenre(\"blues\") → jazz", () => {
    expect(resolveGenre("blues")).toBe("jazz");
  });
  it("post144-extras: resolveGenre(\"classical\") → classical", () => {
    expect(resolveGenre("classical")).toBe("classical");
  });
  it("post144-extras: resolveGenre(\"classic\") → classical", () => {
    expect(resolveGenre("classic")).toBe("classical");
  });
  it("post144-extras: resolveGenre(\"pop\") → pop", () => {
    expect(resolveGenre("pop")).toBe("pop");
  });
  it("post144-extras: resolveGenre(\"dance\") → pop", () => {
    expect(resolveGenre("dance")).toBe("pop");
  });
  it("post144-extras: resolveGenre(\"rock\") → rock", () => {
    expect(resolveGenre("rock")).toBe("rock");
  });
  it("post144-extras: resolveGenre(\"metal\") → rock", () => {
    expect(resolveGenre("metal")).toBe("rock");
  });
  it("post144-extras: resolveGenre(\"indie\") → rock", () => {
    expect(resolveGenre("indie")).toBe("rock");
  });
  it("post144-extras: resolveGenre(\"ambient\") → ambient", () => {
    expect(resolveGenre("ambient")).toBe("ambient");
  });
  it("post144-extras: resolveGenre(\"chill\") → ambient", () => {
    expect(resolveGenre("chill")).toBe("ambient");
  });
  it("post144-extras: resolveGenre(\"focus\") → ambient", () => {
    expect(resolveGenre("focus")).toBe("ambient");
  });
  it("post144-extras: resolveGenre(\"lofi\") → ambient", () => {
    expect(resolveGenre("lofi")).toBe("ambient");
  });
  it("post144-extras: resolveGenre(\"music\") → music", () => {
    expect(resolveGenre("music")).toBe("music");
  });
  it("post144-extras: resolveGenre(\"news\") → news", () => {
    expect(resolveGenre("news")).toBe("news");
  });
  it("post144-extras: resolveGenre(\"sports\") → sports", () => {
    expect(resolveGenre("sports")).toBe("sports");
  });
  it("post144-extras: resolveGenre(\"entertainment\") → entertainment", () => {
    expect(resolveGenre("entertainment")).toBe("entertainment");
  });
  it("post144-extras: resolveGenre(\"unknown-xyz\") → music", () => {
    expect(resolveGenre("unknown-xyz")).toBe("music");
  });
  it("post144-extras: resolveGenre(\"\") → music", () => {
    expect(resolveGenre("")).toBe("music");
  });
  it("post144-extras: resolveGenre(\"MUSIC\") → music", () => {
    expect(resolveGenre("MUSIC")).toBe("music");
  ...
  it("post144-extras: src forbids /playlist", () => {
    for (const f of SRC_FILES) expect(srcOf(f).toLowerCase()).not.toContain("/playlist");
  });
  it("post144-extras: src forbids openai", () => {
    for (const f of SRC_FILES) expect(srcOf(f).toLowerCase()).not.toContain("openai");
  });
  it("post144-extras: src forbids anthropic", () => {
    for (const f of SRC_FILES) expect(srcOf(f).toLowerCase()).not.toContain("anthropic");
  });
  it("post144-extras: src forbids durable_objects", () => {
    for (const f of SRC_FILES) expect(srcOf(f).toLowerCase()).not.toContain("durable_objects");
  });
  it("post144-extras: src forbids workers.ai", () => {
    for (const f of SRC_FILES) expect(srcOf(f).toLowerCase()).not.toContain("workers.ai");
  });
  it("post144-extras: src forbids vectorize", () => {
    for (const f of SRC_FILES) expect(srcOf(f).toLowerCase()).not.toContain("vectorize");
  });
  it("post144-extras: src forbids hyperdrive", () => {
    for (const f of SRC_FILES) expect(srcOf(f).toLowerCase()).not.toContain("hyperdrive");
  });
  it("post144-extras: src forbids ANTHROPIC_API_KEY", () => {
    for (const f of SRC_FILES) expect(srcOf(f).toLowerCase()).not.toContain("anthropic_api_key");
  });
  it("post144-extras: src forbids OPENAI_API_KEY", () => {
    for (const f of SRC_FILES) expect(srcOf(f).toLowerCase()).not.toContain("openai_api_key");
  });
  it("post144-extras: src forbids r2_bucket", () => {
    for (const f of SRC_FILES) expect(srcOf(f).toLowerCase()).not.toContain("r2_bucket");
  });
  it("post144-extras: src forbids d1_database", () => {
    for (const f of SRC_FILES) expect(srcOf(f).toLowerCase()).not.toContain("d1_database");
  });
  it("post144-extras: Env bindings in types.ts", () => {
    const t = read('src/types.ts');
    expect(t).toContain('CATALOG_CACHE: KVNamespace');
    expect(t).toMatch(/GEMINI_API_KEY\?:\s*string/);
    expect(t).toMatch(/VERSION\?:\s*string/);
  });
  it("post144-extras: wrangler aligns with Env", () => {
    const toml = read('wrangler.toml');
  ...
  it("post144-extras: existing envjson lock only", () => {
  ...
  it("post144-extras: inventory digest", () => {
    const keys = ["post144","leftover","TOKENMAXX","HEAVY","after-#144","no-product-invent","source-extras","slice-diff","Env-align","HITL","VALID_GENRES","GENRE_MAP","CATALOG_CACHE","post140","post144","extras"];
    expect(createHash('sha256').update(keys.join('|'), 'utf8').digest('hex')).toBe("0280288724e303de34273127212dffb5be7dc2b8a5fb62c425f93251c0b8197f");
    expect(keys).toHaveLength(16);
  });
  it("post144-extras: final markers", () => {
    const body = read('test/source-contracts.test.ts');
    expect(body).toContain("describe('post144 source-contracts HEAVY deepen (after #144)'");
    expect(body).toContain("describe('post144 source-contracts extras HEAVY deepen (after #144 leftover slice)'");
